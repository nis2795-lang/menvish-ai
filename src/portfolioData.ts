...
export const portfolioCategories: PortfolioCategory[] = [
  ...
  },
  {
    ...
    projects: [
      {
        id: "telecom-design",
        title: "Telecom Network Design Platform",
        problem: "Telecommunication providers require large-scale network planning and infrastructure management.",
        highlights: [
          "Enterprise network modeling handling 15,000+ complex network assets",
          "Complex topology processing optimizing link distances",
          "Multi-user collaboration for engineers",
          "High-performance backend modules cutting query times"
        ]
      },
      {
        id: "asset-promotion",
        title: "Network Asset Promotion Engine",
        problem: "Large telecom networks require automated promotion of design changes across multiple infrastructure layers.",
        highlights: [
          "Automated network asset promotion processing 10+ sites daily",
          "Zero-error dependency resolution across layered infrastructure",
          "Workflow automation replacing manual spreadsheet steps",
          "Enterprise-grade scalability"
        ]
      },
      {
        id: "network-processing",
        title: "High-Performance Network Modules",
        problem: "Telecom network operations require rapid processing of thousands of network entities.",
        highlights: [
          "Performance optimization querying 50,000+ network entities efficiently",
          "Memory-efficient processing cutting server RAM needs",
          "Reduced execution latency to sub-second responses",
          "Large-scale network computations spanning national telco grids"
        ]
      }
    ]
  }
